        ...
        try {
            ...
            Pair_Code_By_Ibrahim_Adams.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    let sessionMessage = await Pair_Code_By_Gifted_Tech.sendMessage(Pair_Code_By_Gifted_Tech.user.id, {
                        text: 'Gifted;;;' + b64data
                    });
                    ...
                    await Pair_Code_By_Gifted_Tech.sendMessage(Pair_Code_By_Gifted_Tech.user.id, { 
                        ...
                        fileName: 'shizo',
                        contextInfo: {
                            mentionedJid: [Pair_Code_By_Gifted_Tech.user.id], // Mention the sender in the audio message
                            externalAdReply: {
